...
class DDPG:
    def __init__(self, args):
        ...
        self.scheduler_lr_a = opt.lr_scheduler.CyclicLR(self.actor_optimizer,
                                                        base_lr=base_lr, max_lr=lr_a, step_size_up=step_size_up,
                                                        mode="triangular2", cycle_momentum=False)
        self.scheduler_lr_c = opt.lr_scheduler.CyclicLR(self.critic_optimizer,
                                                        base_lr=base_lr, max_lr=lr_c, step_size_up=step_size_up,
                                                        mode="triangular2", cycle_momentum=False)
        ...
        if load_or_not is False:
            ...
            # load model
            load_path = self.args.load_dir + '/' + self.args.load_scenario_name + '/agent_params'
    ...
    # update the network
    def train(self, state, action, reward, s_next):
